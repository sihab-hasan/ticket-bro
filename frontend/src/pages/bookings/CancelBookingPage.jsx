...
const CancelBookingPage = () => {
  ...
  if (loading) return <Container aria-label="Cancel booking loading"><div className="py-4 space-y-4"><Skeleton className="h-8 w-48" /><Skeleton className="h-64 w-full rounded-2xl" /></div></Container>;

  if (cancelled) return (
    <Container aria-label="Booking cancelled"><div className="py-6 max-w-md mx-auto text-center space-y-4 font-sans">
