...
const WaitlistPage = () => {
  ...
  if (loading) return <Container aria-label="Waitlist loading"><div className="py-4 space-y-4"><Skeleton className="h-8 w-48" /><Skeleton className="h-64 w-full rounded-2xl" /></div></Container>;

  if (joined || alreadyJoined) return (
    <Container aria-label="Waitlist joined"><div className="py-12 max-w-md mx-auto text-center space-y-4 font-sans">
